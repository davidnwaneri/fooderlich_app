...
abstract class FooderlichService {
  Future<ExploreData> getExploreData();
  Future<List<ExploreRecipe>> _getTodayRecipes();
  Future<List<Post>> _getFriendFeed();
  Future<List<SimpleRecipe>> getRecipes();
}

// Mock recipe service that grabs sample json data to mock recipe request/response
class MockFooderlichService implements FooderlichService {
