...
import '../api/models/models.dart' as _i10;
import '../presentation/explore/explore.screen.dart' as _i5;
import '../presentation/grocery/view/create_grocery_item_screen.dart' as _i2;
import '../presentation/grocery/view/grocery_screen.dart' as _i7;
import '../presentation/home/home_page.dart' as _i1;
import '../presentation/recipe/recipe_view.dart' as _i6;
import '../profile/profile_page.dart' as _i3;
import '../profile/web_view_page.dart' as _i4;
...
class AppRouter extends _i8.RootStackRouter {
  ...
  final Map<String, _i8.PageFactory> pagesMap = {
    ...
    WebViewRoute.name: (routeData) {
      return _i8.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i4.WebViewPage());
    },
    ...
    RecipeRouter.name: (routeData) {
      return _i8.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i6.RecipeView());
    },
    GroceryRouter.name: (routeData) {
      return _i8.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i7.GroceryScreen());
    }
  };
  ...
  List<_i8.RouteConfig> get routes => [
        _i8.RouteConfig(HomeRoute.name, path: '/', children: [
          _i8.RouteConfig(ExploreRouter.name,
              path: 'explore', parent: HomeRoute.name),
          _i8.RouteConfig(RecipeRouter.name,
              path: 'recipe', parent: HomeRoute.name),
          _i8.RouteConfig(GroceryRouter.name,
              path: 'groceries', parent: HomeRoute.name)
        ]),
        _i8.RouteConfig(EditGroceryItemRouter.name, path: 'edit-grocery-item'),
        _i8.RouteConfig(CreateGroceryItemRouter.name,
            path: 'create-grocery-item'),
        _i8.RouteConfig(ProfileRoute.name, path: '/profile'),
        _i8.RouteConfig(WebViewRoute.name, path: '/web-view')
      ];
}
...
class EditGroceryItemRouter
    extends _i8.PageRouteInfo<EditGroceryItemRouterArgs> {
  EditGroceryItemRouter({_i9.Key? key, _i10.GroceryItem? groceryItemToEdit})
...
class EditGroceryItemRouterArgs {
  ...
  final _i10.GroceryItem? groceryItemToEdit;
...
class CreateGroceryItemRouter
    extends _i8.PageRouteInfo<CreateGroceryItemRouterArgs> {
  CreateGroceryItemRouter({_i9.Key? key, _i10.GroceryItem? groceryItemToEdit})
...
/// generated route for
/// [_i4.WebViewPage]
class WebViewRoute extends _i8.PageRouteInfo<void> {
  const WebViewRoute() : super(WebViewRoute.name, path: '/web-view');
...
/// generated route for
/// [_i5.ExploreScreen]
class ExploreRouter extends _i8.PageRouteInfo<void> {
...
/// generated route for
/// [_i6.RecipeView]
class RecipeRouter extends _i8.PageRouteInfo<void> {
...
/// generated route for
/// [_i7.GroceryScreen]
class GroceryRouter extends _i8.PageRouteInfo<void> {
